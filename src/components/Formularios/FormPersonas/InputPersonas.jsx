...
function InputPersonas({control,errors={}, onlyView=true}) {
    const inputsTest = [
        ...
        { name:'Actividad', control:control, label:'Actividad', type:'text', error:errors.Direccion,estilos:'col-6' , readOnly:onlyView},
        ...
        { name:'PEP', control:control, label:'Persona expuesta politicamente', type:'select', error:errors.select,estilos:'col-3',options:PepOptions , defaultValue:'No',readOnly:onlyView},
          { name:'EstadoPersona', control:control, label:'Estado', type:'select', error:errors.select,estilos:'col-2',options:EstadosOptions, defaultValue:'A' , readOnly:onlyView},
      ]
  return (
