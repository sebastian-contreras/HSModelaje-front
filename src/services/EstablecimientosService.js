...
export async function updateEstablecimientoApi (usuario, id) {
  delete usuario.id
  const response = await axios.put(`${API_URL}/api/establecimientos/` + id, usuario)
  return response.data
}
...
export async function darBajaEstablecimientoApi (id) {
  const response = await axios.post(`${API_URL}/api/establecimientos/darbaja/` + id)
  return response.data
}
export async function activarEstablecimientoApi (id) {
  const response = await axios.post(`${API_URL}/api/establecimientos/activar/` + id)
  return response.data
}